...
- Date: 2026-08-07
- Status: proposed — unit-verified with a real local HTTP server; not yet verified against a live Claude Code run actually invoking this tool through `--mcp-config`.
